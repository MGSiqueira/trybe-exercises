...
describe('Testando .resolves e .rejects com promise - findAnimalsByType', () => {
  describe('Quando o tipo do animal existe', () => {
    test('Retorne a lista de animais', () => {
      const listDogs = [
        { name: 'Dorminhoco', age: 1, type: 'Dog' },
...
describe('Testando .resolves e rejects com Async/Await - findAnimalsByType', () => {
  describe('Quando o tipo do animal existe', () => {
